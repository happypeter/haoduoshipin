...
注：下面是我翻译的 [Web Bos](http://wesbos.com/javascript-modules/) 的一篇文章。
...
编写 Javascript 模块的想法并不新鲜，但随着 ES6 的推广和业内认定 npm 为 Javascript 首选的包管理工具，我们刚开始看到许多开发者远离上述老的工作流，而开始致力于 ES6 和 npm 的标准化。
